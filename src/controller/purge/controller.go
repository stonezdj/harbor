...
type Controller interface {
	// Start start a purge schedule
	Start(ctx context.Context, policy PurgeJobPolicy, trigger string) (int64, error)
}
...
func (c *controller) Start(ctx context.Context, policy PurgeJobPolicy, trigger string) (int64, error) {
