...
// GetTask provides a mock function with given fields: ctx, vendorType, id
func (_m *TaskController) GetTask(ctx context.Context, vendorType string, id int64) (*jobservice.Task, error) {
...
// GetTaskLog provides a mock function with given fields: ctx, vendorType, id
func (_m *TaskController) GetTaskLog(ctx context.Context, vendorType string, id int64) ([]byte, error) {
	ret := _m.Called(ctx, vendorType, id)
...
// ListTasks provides a mock function with given fields: ctx, vendorType, query
func (_m *TaskController) ListTasks(ctx context.Context, vendorType string, query *q.Query) ([]*jobservice.Task, error) {
