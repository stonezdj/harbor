...
// ExecutionCount provides a mock function with given fields: ctx, vendorType, query
func (_m *ExecutionController) ExecutionCount(ctx context.Context, vendorType string, query *q.Query) (int64, error) {
...
// GetExecution provides a mock function with given fields: ctx, vendorType, executionID
func (_m *ExecutionController) GetExecution(ctx context.Context, vendorType string, executionID int64) (*jobservice.Execution, error) {
...
// ListExecutions provides a mock function with given fields: ctx, vendorType, query
func (_m *ExecutionController) ListExecutions(ctx context.Context, vendorType string, query *q.Query) ([]*jobservice.Execution, error) {
	ret := _m.Called(ctx, vendorType, query)
