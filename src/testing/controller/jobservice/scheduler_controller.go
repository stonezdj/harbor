...
// CreateSchedule provides a mock function with given fields: ctx, vendorType, cronType, cron, callbackFuncName, policy, extrasParam
func (_m *SchedulerController) CreateSchedule(ctx context.Context, vendorType string, cronType string, cron string, callbackFuncName string, policy interface{}, extrasParam map[string]interface{}) (int64, error) {
...
// DeleteSchedule provides a mock function with given fields: ctx, vendorType
func (_m *SchedulerController) DeleteSchedule(ctx context.Context, vendorType string) error {
...
// GetSchedule provides a mock function with given fields: ctx, vendorType
func (_m *SchedulerController) GetSchedule(ctx context.Context, vendorType string) (*scheduler.Schedule, error) {
	ret := _m.Called(ctx, vendorType)
