...
var (
	...
	ConfigList = []Item{
		...
		{Name: common.AuditLogDisable, Scope: UserScope, Group: BasicGroup, EnvKey: "AUDIT_LOG_DISABLE_LIST", DefaultValue: "", ItemType: &StringType{}, Editable: false, Description: `The option to skip audit log for some operations, the key is <operation>_<resource_type> like create_user, delete_user, separated by comma`},
