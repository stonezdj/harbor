...
var (
	...
	ConfigList = []Item{
		...
		{Name: common.SkipLogAuditDatabase, Scope: UserScope, Group: BasicGroup, EnvKey: "SKIP_LOG_AUDIT_DATABASE", DefaultValue: "false", ItemType: &BoolType{}, Editable: false, Description: `The option to skip audit log in database`},
	}
)
