...
var (
	...
	ConfigList = []Item{
		...
		{Name: common.CfgCacheIntervalSeconds, Scope: UserScope, Group: BasicGroup, EnvKey: "CFG_CACHE_INTERVAL_SECONDS", DefaultValue: "20", ItemType: &IntType{}, Editable: false},
