...
var (
	...
	ConfigList = []Item{
		...
		{Name: common.LDAPOnBoardGroupAtLogin, Scope: UserScope, Group: LdapBasicGroup, EnvKey: "LDAP_GROUP_ONBOARD_GROUP_AT_LOGIN", DefaultValue: "false", ItemType: &BoolType{}, Editable: true},
