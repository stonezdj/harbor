...
func (o *ListRepositoriesURL) Build() (*url.URL, error) {
	...
	var _path = "/projects/{project_name}/repositories"
...
func (o *ListRepositoriesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListRepositoriesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListRepositoriesURL")
	}
