...
func (o *UpdateRepositoryURL) Build() (*url.URL, error) {
	...
	var _path = "/projects/{project_name}/repositories/{repository_name}"

	projectName := o.ProjectName
	if projectName != "" {
		_path = strings.Replace(_path, "{project_name}", projectName, -1)
	} else {
		return nil, errors.New("projectName is required on UpdateRepositoryURL")
	}
	...
	if repositoryName != "" {
		...
		return nil, errors.New("repositoryName is required on UpdateRepositoryURL")
	}
...
func (o *UpdateRepositoryURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateRepositoryURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateRepositoryURL")
	}
