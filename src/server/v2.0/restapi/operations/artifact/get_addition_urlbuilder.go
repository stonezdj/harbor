...
func (o *GetAdditionURL) Build() (*url.URL, error) {
	...
	var _path = "/projects/{project_name}/repositories/{repository_name}/artifacts/{reference}/additions/{addition}"

	addition := o.Addition
	if addition != "" {
		_path = strings.Replace(_path, "{addition}", addition, -1)
	} else {
		return nil, errors.New("addition is required on GetAdditionURL")
	}
	...
	if projectName != "" {
		...
		return nil, errors.New("projectName is required on GetAdditionURL")
	}
	...
	if reference != "" {
		...
		return nil, errors.New("reference is required on GetAdditionURL")
	}
	...
	if repositoryName != "" {
		...
		return nil, errors.New("repositoryName is required on GetAdditionURL")
	}
...
func (o *GetAdditionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAdditionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAdditionURL")
	}
