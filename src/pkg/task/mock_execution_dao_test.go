...
// GetEndTime provides a mock function with given fields: ctx, executionID
func (_m *mockExecutionDAO) GetEndTime(ctx context.Context, executionID int64) (*time.Time, error) {
