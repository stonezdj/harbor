...
type Scheduler interface {
	...
	// CountSchedule counts the schedules according to the query
	CountSchedule(ctx context.Context, query *q.Query) (int64, error)
}
...
func (s *scheduler) CountSchedule(ctx context.Context, query *q.Query) (int64, error) {
